*&---------------------------------------------------------------------*
*& Modulpool  ZAR_MODULE_POOL_SELECT_OPTION
*&
*&---------------------------------------------------------------------*
*&
*&
*&---------------------------------------------------------------------*
PROGRAM zar_module_pool_select_option.
...
CONTROLS: ZAR_TABLE TYPE TABLEVIEW USING SCREEN 0100.
...
MODULE ZAR_TABLE_CHANGE_TC_ATTR OUTPUT.
  DESCRIBE TABLE LT_EMPLOYEE LINES ZAR_TABLE-lines.
ENDMODULE.
